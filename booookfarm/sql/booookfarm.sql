...
CREATE TABLE MEMBERS(
	 MEMBER_ID 			VARCHAR2(15) 	CONSTRAINT NN_MEMBER_ID		   NOT NULL
...
CREATE TABLE ORDER_INFO(
	  ORDER_CODE		NUMBER			CONSTRAINT NN_ORDER_CODE		     NOT NULL
	 ,BOOK_CODE			VARCHAR2(10)	CONSTRAINT NN_ORDER_BOOK_CODE		 NOT NULL
	 ,BOOK_TITLE	    VARCHAR2(200)	CONSTRAINT NN_ORDER_BOOK_TITLE  	 NOT NULL
	 ,BOOK_PRICE		NUMBER 		    CONSTRAINT NN_ORDER_BOOK_PRICE  	 NOT NULL
	 ,BOOK_DISCOUNT     NUMBER			CONSTRAINT NN_ORDER_BOOK_DISCOUNT    NOT NULL
	 ,ORDER_QUANTITY    NUMBER 			CONSTRAINT NN_ORDER_QUANTITY 		 NOT NULL
	 ...
	 ,MEMBER_ID			VARCHAR2(15)	CONSTRAINT NN_ORDER_MEMBER_ID		 NOT NULL
	 ...
	 ,CANCLE_DATE		DATE			DEFAULT(SYSDATE) CONSTRAINT NN_ORDER_CANCLE_DATE	 NOT NULL
...
CREATE TABLE REFUND_INFO(
	 ...
	 ,MEMBER_ID				VARCHAR2(15)	CONSTRAINT NN_REFUND_MEMBER_ID		 NOT NULL
...
CREATE TABLE BASKET(
	...
	,MEMBER_ID			VARCHAR2(15)	CONSTRAINT NN_BASKET_MEMBER_ID 	  NOT NULL
...
CREATE TABLE LAST_VIEW(
	...
	,MEMBER_ID		VARCHAR2(15)	CONSTRAINT NN_LAST_VIEW_MEMBER_ID NOT NULL
...
CREATE TABLE QUESTION_INFO(
	...
	,MEMBER_ID			VARCHAR2(15)	CONSTRAINT NN_QUESTION_MEMBER_ID NOT NULL
